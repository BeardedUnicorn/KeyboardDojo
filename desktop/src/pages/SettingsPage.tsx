...
import type { ReactNode, FC , ChangeEvent, SyntheticEvent } from 'react';
...
const SettingsPage: FC = () => {
  ...
  const handleLineNumbersChange = (event: ChangeEvent<HTMLInputElement>) => {
    const newValue = event.target.checked;
  ...
  const handleMinimapChange = (event: ChangeEvent<HTMLInputElement>) => {
    const newValue = event.target.checked;
