      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        >
          ...
          <TabPanel value={tabValue} index={1}>
            ...
            <CurriculumProgressChart showDetails={true} />
          </TabPanel>
        ...
        <Box sx={{ mt: 4, p: 3, bgcolor: 'background.paper', borderRadius: 2 }}>
          ...
          <Typography variant="body2" color="text.secondary">
            Regular practice is key to mastering keyboard shortcuts. Try to maintain your streak and practice a little each day.
          </Typography>
        </Box>
      </Container>
    </MainLayout>
