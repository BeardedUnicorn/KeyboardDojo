      ...
      <DialogContent dividers>
        {loading ? (
          ...
          <Box sx={{ py: 1 }}>
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(e) => 
                    handleChange('startWithSystem', e.target.checked)
                  }
                  color="primary"
                />
              }
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  onChange={(e) => 
                    handleChange('minimizeToTray', e.target.checked)
                  }
                  color="primary"
                />
              }
            ...
            >
              <InputLabel id="keyboard-layout-label">
                Keyboard Layout
              </InputLabel>
              <Select
                ...
                onChange={(e) => 
                  handleChange('keyboardLayout', e.target.value)
                }
              >
