...
export const FeedbackAnimation: FC<FeedbackAnimationProps> = ({
  type,
  size = 40,
  color,
  children,
...
export const SuccessIcon: FC<{ size?: number; color?: string }> = ({ size = 24, color }) => (
  <FeedbackAnimation type="success" size={size} color={color}>
...
export const ErrorIcon: FC<{ size?: number; color?: string }> = ({ size = 24, color }) => (
  <FeedbackAnimation type="error" size={size} color={color}>
    <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor">
...
export const LoadingIcon: FC<{ size?: number; color?: string }> = ({ size = 24, color }) => (
  <FeedbackAnimation type="loading" size={size} color={color}>
