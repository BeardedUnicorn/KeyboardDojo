...
import { HEARTS_CONFIG, heartsService } from '../../../services';

import type { HeartsChangeEvent } from '../../../services/heartsService';
...
const HeartsDisplay: FC<HeartsDisplayProps> = ({
  ...
  useEffect(() => {
    ...
    const handleHeartsChange = (data: HeartsChangeEvent) => {
