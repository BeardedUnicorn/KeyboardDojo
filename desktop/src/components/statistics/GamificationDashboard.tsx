...
import { selectAchievements, selectCompletedAchievements } from '../../store/slices/achievementsSlice';
import { selectXp, selectLevel } from '../../store/slices/userProgressSlice';
import { CurrencyDisplay, HeartsDisplay, Inventory, Store } from '../gamification';
